...
```bash
git clone https://github.com/ardhi/allo-backend-test-main.git
...
```json
{
  ...
  "data": {
    ...
    "USD_BuySpread_IDR": 16083.20,
    "spread_factor": 0.00520,
    "github_username": "ardhi"
  }
}
```
...
| Item | Value |
|---|---|
| **GitHub Username** | `ardhi` |
| **Characters (lowercase)** | a, r, d, h, i |
| **Unicode Values** | a=97, r=114, d=100, h=104, i=105 |
| **Sum of Unicode Values** | **520** |
| **Spread Factor** | `(520 % 1000) / 100000.0` = **0.00520** |

**Formula applied:**
```
USD_BuySpread_IDR = (1 / Rate_USD) * (1 + 0.00520)
```

For example, if `Rate_USD = 0.0000625`:
```
USD_BuySpread_IDR = (1 / 0.0000625) * (1 + 0.00520) = 16000 * 1.00520 = 16,083.20 IDR
```
